...
#SBATCH --job-name=doc.mt.65536.v4.pretrain.ft.cb.0.5.full.diff.key.pos
...
slang=en
SAVE=${SAVE_ROOT}/mt_v5_sep_65536_4_chunk_512_cb_ft_w0.5_full_diff_key_seg_pos_base
mkdir -p ${SAVE}
...
python -u train.py ${DATA} \
     ...
     --input-form sep --context-form window --window-size 3 --context-compress '2,2' \
