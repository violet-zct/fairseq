...
#SBATCH --job-name=doc.mt.65536.v4.pretrain.ft.cb.0.5.full
...
slang=en
SAVE=${SAVE_ROOT}/mt_v4_sep_65536_4_chunk_512_cb_ft_w0.5_full_base
mkdir -p ${SAVE}
...
python -u train.py ${DATA} \
     ...
     --sep-attn-share-key-proj 1 --fix-code-book 0 --tokens-per-sample 10000000 \
